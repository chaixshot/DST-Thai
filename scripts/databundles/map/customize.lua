...
local day_descriptions = {
	...
	{ text = STRINGS.UI.SANDBOXMENU.DUSK..STRINGS.UI.SANDBOXMENU.SLIDELONG, data = "longdusk" },
	{ text = STRINGS.UI.SANDBOXMENU.NIGHT..STRINGS.UI.SANDBOXMENU.SLIDELONG, data = "longnight" },
